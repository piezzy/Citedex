...
const testimonials = [
  {
    ...
    content: "DRI saved us countless hours. The AI extraction is incredibly accurate, and we registered 50 papers in a single afternoon. Absolutely game-changing for our lab.",
    rating: 5,
    initials: "EC"
  },
  {
  ...
  },
  {
    ...
    content: "We migrated our entire lab to DRI. The bulk upload feature and API access make it perfect for large research groups. Best investment we've made this year.",
    rating: 5,
    initials: "LW"
  },
  {
